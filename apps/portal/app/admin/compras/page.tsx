...
export default async function ProcurementPage() {
  ...
  return <div className="px-4 py-8 sm:px-6 lg:px-8 lg:py-10"><div className="mx-auto max-w-[var(--g-content-standard)] space-y-6">
    ...
    <Link href="/admin/compras/pedidos" className="inline-flex min-h-11 items-center rounded-[var(--g-radius-control)] bg-[var(--g-brand-primary)] px-4 font-semibold text-white">Pedidos de compra</Link>
    <SupplierManagement />
  </div></div>;
}
