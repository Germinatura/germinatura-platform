        ...
        <section aria-labelledby="quick-actions-title">
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            ...
            <Card className="group relative overflow-hidden p-6 transition-transform hover:-translate-y-0.5">
              ...
              <Link href="/perfil" className="mt-5 inline-flex min-h-11 items-center gap-2 text-sm font-semibold text-[var(--g-brand-primary)]">Editar perfil <ArrowRight className="size-4" /></Link>
            </Card>
