...
export function PurchaseOrdersManagement({ products }: { products: Product[] }) {
  ...
  const [status, setStatus] = useState<"ALL" | "OPEN" | "PARTIALLY_RECEIVED" | "RECEIVED" | "CANCELLED">("ALL");
