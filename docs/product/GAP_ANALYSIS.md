...
| Compras | Fornecedores e pedidos integrados em staging; recebimento parcial por lote, rateio e obrigação vinculada em validação local | Integrar recebimento; rastrear lote até venda e liquidar obrigação sem duplicação | 3 |
